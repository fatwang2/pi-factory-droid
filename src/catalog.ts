...
const FALLBACK_ROWS: FallbackRow[] = [
  ...
  { id: "grok-4.6", name: "Grok 4.6", provider: "xai", efforts: [ReasoningEffort.Low, ReasoningEffort.Medium, ReasoningEffort.High], image: true },
  { id: "grok-4.5", name: "Grok 4.5", provider: "xai", efforts: [ReasoningEffort.Low, ReasoningEffort.Medium, ReasoningEffort.High], image: true },
